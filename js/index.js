...
const translations = {
    en: {
        ...
        third_experience_role: `Cashier/Stock Clerk`,
        third_experience_company: `Mercadona`,
        third_experience_location: `Lloret de Mar, Spain`,
        third_experience_date: `May 2025 - Sep 2025`,
        third_experience_task_1: `Managed customer payments, returns, and inquiries, ensuring a positive shopping experience and resolving issues quickly and effectively.`,
        third_experience_task_2: `Organized and restocked products, maintaining order and ensuring a clear and accessible display for customers.`,
        third_experience_task_3: `Collaborated with the team in task distribution and supported different store sections to optimize efficiency and maintain a good working atmosphere.`,
        fourth_experience_role: `Cashier/Stock Clerk`,
        fourth_experience_company: `Mercadona`,
        fourth_experience_location: `Lloret de Mar, Spain`,
        fourth_experience_date: `May 2025 - Sep 2025`,
        fourth_experience_task_1: `Managed customer payments, returns, and inquiries, ensuring a positive shopping experience and resolving issues quickly and effectively.`,
        fourth_experience_task_2: `Organized and restocked products, maintaining order and ensuring a clear and accessible display for customers.`,
        fourth_experience_task_3: `Collaborated with the team in task distribution and supported different store sections to optimize efficiency and maintain a good working atmosphere.`,
        fourth_experience_task_4: `Followed safety procedures when handling merchandise, ensuring a safe and efficient working environment.`,
    ...
    es: {
        ...
        third_experience_role: `Cajero/Reponedor`,
        third_experience_company: `Mercadona`,
        third_experience_location: `Lloret de Mar, España`,
        third_experience_date: `May 2025 - Sep 2025`,
         third_experience_date: `May 2026 - Sep 2025`,
        third_experience_task_1: `Gestioné cobros, devoluciones y consultas de los clientes, asegurando una experiencia de compra positiva y resolviendo incidencias de manera rápida y eficaz.`,
        third_experience_task_2: `Ordené y repuse productos manteniendo el orden y asegurando una exposición clara y accesible para los clientes.`,
        third_experience_task_3: `Colaboré con el equipo en el reparto de tareas y apoyé en distintas secciones del supermercado para optimizar la eficiencia y el buen ambiente de trabajo.`,
        third_experience_task_4: `Cumplí con los procedimientos de seguridad en el manejo de mercancía, garantizando un entorno de trabajo seguro y eficiente.`,
        fourth_experience_role: `Desarrollador Web + Marketing Digital`,
        fourth_experience_company: `Club Esportiu Nova Unió`,
        fourth_experience_location: `Lloret de Mar, España`,
        fourth_experience_date: `Sep 2025 - Actualidad`,
        fourth_experience_task_1: `Desarrollé y mantengo el sitio web del club, implementando mejoras continuas para optimizar la experiencia del usuario y asegurar una presencia online efectiva.`,
        fourth_experience_task_2: `Desarrollé una plataforma privada para la gestión eficiente de alumnos, pagos, asistencias, etc., facilitando la administración interna del club.`,
        fourth_experience_task_3: `Ayudo en la creación de contenido digital para promocionar el club y sus actividades en redes sociales, aumentando la visibilidad y el alcance del club en la comunidad local.`,
