...
const translations = {
    en: {
        title: 'Samuel Cañadas - Junior Web Developer',
        about: 'About',
        projects: 'Projects',
        experience: 'Experience',
        contact: 'Contact',
        aspiring_dev: 'Junior Web Developer',
        ...
        project_1_description: `NFL 1 is the first MMA event by Nova Fight Legacy, born in Lloret de Mar with the goal of bringing together national and international talent. For this project, I help shape its overall visual identity and content, from design and video creation to its promotion across social media.`,
        ...
        third_experience_company: `Club Esportiu Nova Unió`,
        third_experience_role: `Web Developer + Digital Marketing`,
        third_experience_location: `Lloret de Mar, Spain`,
        third_experience_date: `Jan 2026 - May 2026`,
        third_experience_task_1: `Developed and maintain the club's website, making continuous improvements to enhance the user experience and maintain an effective online presence.`,
        third_experience_task_2: `Developed a private platform for efficiently managing students, payments, attendance, and other administrative tasks, making the club's internal management easier.`,
        third_experience_task_3: `Help create digital content to promote the club and its activities on social media, helping increase the club's visibility and reach within the local community.`,
        fourth_experience_role: `Creative + Social Media`,
        fourth_experience_company: `Nova Fight Legacy`,
        fourth_experience_location: `Lloret de Mar, Spain`,
        fourth_experience_date: `May 2026 - Present`,
        fourth_experience_task_1: `Designed the Nova Fight Legacy logo and main visual elements, establishing a recognizable identity for the project.`,
        fourth_experience_task_2: `Create posters and other graphic materials for events, adapting the promoter's visual identity to each fight and activity.`,
        fourth_experience_task_3: `Create and edit social media content, mainly graphic materials and videos related to events and participants.`,
        fourth_experience_task_4: `Manage the social media presence by publishing content and helping promote the promoter's events and updates.`,
        fourth_experience_task_5: `Help with the preparation and promotion of events, contributing ideas and visual resources to help bring each project together.`,
    ...
    es: {
        title: 'Samuel Cañadas - Desarrollador Web Junior',
        about: 'Sobre mí',
        projects: 'Proyectos',
        experience: 'Experiencia',
        contact: 'Contacto',
        aspiring_dev: 'Desarrollador Web Junior',
        ...
        project_1_description: `NFL 1 es el primer evento de MMA de Nova Fight Legacy, nacido en Lloret de Mar con la intención de reunir talento nacional e internacional. En este proyecto me encargo de dar forma a toda su imagen y contenido, desde el diseño y la creación audiovisual hasta su promoción en redes sociales.`,
        project_2_title: `CE NOVA UNIÓ`,
        ...
        third_experience_role: `Desarrollador Web + Marketing Digital`,
        third_experience_company: `Club Esportiu Nova Unió`,
        third_experience_location: `Lloret de Mar, España`,
        third_experience_date: `Ene 2026 - May 2026`,
        third_experience_task_1: `Desarrollé y mantengo el sitio web del club, implementando mejoras continuas para optimizar la experiencia del usuario y asegurar una presencia online efectiva.`,
        third_experience_task_2: `Desarrollé una plataforma privada para la gestión eficiente de alumnos, pagos, asistencias, etc., facilitando la administración interna del club.`,
        third_experience_task_3: `Ayudo en la creación de contenido digital para promocionar el club y sus actividades en redes sociales, aumentando la visibilidad y el alcance del club en la comunidad local.`,
        fourth_experience_role: `Creativo + Redes Sociales`,
        fourth_experience_company: `Nova Fight Legacy`,
        fourth_experience_location: `Lloret de Mar, España`,
        fourth_experience_date: `May 2026 - Actualidad`,
        fourth_experience_task_1: `Diseñé el logotipo y los principales elementos visuales de Nova Fight Legacy, estableciendo una imagen reconocible para el proyecto.`,
        fourth_experience_task_2: `Creo carteles y diferentes piezas gráficas para los eventos, adaptando la imagen de la promotora a cada combate y actividad.`,
        fourth_experience_task_3: `Creo y edito contenido para redes sociales, principalmente piezas gráficas y vídeos relacionados con los eventos y los participantes.`,
        fourth_experience_task_4: `Me encargo de mantener activas las redes sociales, publicando contenido y dando visibilidad a los eventos y novedades de la promotora.`,
        fourth_experience_task_5: `Colaboro en la preparación y promoción de los eventos, aportando ideas y recursos visuales para ayudar a que cada proyecto salga adelante.`,
